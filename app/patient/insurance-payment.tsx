...
export default function InsurancePayment() {
  ...
  const handleSubmit = async () => {
    if (!insuranceProvider || !policyNumber || !memberName) {
      return;
    }
    ...
    try {
      ...
      const transactionData = {
        ...
        payment_reference: `INS-${Date.now()}-${Math.random().toString(36).substring(7)}`,
        status: 'completed',
        metadata: {
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerTitle}>Insurance / HMO</Text>
        <View style={{ width: 24 }} />
      </View>
      ...
      <ScrollView style={styles.content} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.formSection}>
          ...
          <View style={styles.formGroup}>
            <Text style={styles.label}>Insurance Provider / HMO *</Text>
            <TextInput
              style={styles.input}
              placeholder="e.g., Hygeia HMO, Reliance HMO"
          ...
          <View style={styles.formGroup}>
            ...
            <TextInput
              style={styles.input}
              placeholder="Name as it appears on policy"
              value={memberName}
        ...
        <View style={styles.noteCard}>
          ...
          <Text style={styles.noteText}>
            1. We'll verify your insurance details{'\n'}
            2. Your insurance provider will be contacted{'\n'}
            3. You'll receive confirmation within 24-48 hours{'\n'}
            4. Your subscription will be activated upon approval
          </Text>
        </View>
      </ScrollView>
        ...
        <View style={styles.modalOverlay}>
          <View style={styles.successModalContent}>
            <View style={styles.successModalCard}>
              ...
              <Text style={styles.successHeader}>Insurance Verified</Text>
